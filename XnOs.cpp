...
void XnOs::reset(){
	this->pr1=0;this->pr2=0;this->pr3=0;this->pr4=0;this->pc1=0;this->pc2=0;this->pc3=0;this->pc4=0;this->pd1=0;this->pd2=0;
	this->cr1=0;this->cr2=0;this->cr3=0;this->cr4=0;this->cc1=0;this->cc2=0;this->cc3=0;this->cc4=0;this->cd1=0;this->cd2=0;
...
int XnOs::findmax(){
	...
	if(maxr>=maxd&&maxr>=maxc)
		max=maxr;
	else if(maxd>=maxr&&maxd>=maxc)
		max=maxd;
	else if(maxc>=maxr&&maxc>=maxd)
		max=maxc;
...
void XnOs::displayplayer(int p[7],int i){
	if(p[i]==11){
...
void XnOs::displaycomputer(int p[7],int i){
	if(p[i]==11){
